...
namespace POS.Api.Migrations
{
    ...
    [Migration("20251128201606_AddTenantToCategories")]
    partial class AddTenantToCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.Api.Models.Company", b =>
                {
                    b.Property<int>("CompanyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POS.Api.Models.CustomerLedger", b =>
                {
            ...
            modelBuilder.Entity("POS.Api.Models.InvoicePayment", b =>
                {
            ...
            modelBuilder.Entity("POS.Api.Models.AccountingEntry", b =>
                {
                    ...
                    b.HasOne("POS.Api.Models.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("POS.Api.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("POS.Api.Models.Invoice", "OriginalInvoice")
                        .WithMany()
                        .HasForeignKey("OriginalInvoiceId");

                    b.HasOne("POS.Api.Models.Return", "Return")
                        .WithOne("CreditNoteInvoice")
                        .HasForeignKey("POS.Api.Models.Invoice", "ReturnId");
